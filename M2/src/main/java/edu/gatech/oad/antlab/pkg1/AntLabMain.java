...
public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        Person1 p1 = new Person1("Ted Shang");
        toPrint += p1.toString("tshang3");

        //Person2 replace P2 with your name
        //and gburdell with your gt id
        Person2 p2 = new Person2("Melanie Hall");
        toPrint += p2.toString("thall63");
        ...
        Person5 p5 = new Person5("Jordan Taylor");
        toPrint += p5.toString("jtaylor351");
